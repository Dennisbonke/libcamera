...
const std::map<V4L2PixelFormat, V4L2PixelFormat::Info> vpf2pf{
	...
	{ V4L2PixelFormat(V4L2_PIX_FMT_SGRGB_IGIG_GBGR_IGIG10),
		{ formats::SGRGB_IGIG_GBGR_IGIG10, "10-bit Bayer GRGB/IGIG/GBGR/IGIG" } },
	...
	{ V4L2PixelFormat(V4L2_PIX_FMT_SGRGB_IGIG_GBGR_IGIG10P),
		{ formats::SGRGB_IGIG_GBGR_IGIG10_CSI2P, "10-bit Bayer GRGB/IGIG/GBGR/IGIG Packed" } },
