...
const std::map<BayerFormat, Formats, BayerFormatComparator> bayerToFormat{
	...
	{ { BayerFormat::GRGB_IGIG_GBGR_IGIG, 10, BayerFormat::Packing::None },
		{ formats::SGRGB_IGIG_GBGR_IGIG10, V4L2PixelFormat(V4L2_PIX_FMT_SGRGB_IGIG_GBGR_IGIG10) } },
	...
	{ { BayerFormat::GRGB_IGIG_GBGR_IGIG, 10, BayerFormat::Packing::CSI2 },
		{ formats::SGRGB_IGIG_GBGR_IGIG10_CSI2P, V4L2PixelFormat(V4L2_PIX_FMT_SGRGB_IGIG_GBGR_IGIG10P) } },
...
const std::unordered_map<unsigned int, BayerFormat> mbusCodeToBayer{
	...
	{ MEDIA_BUS_FMT_SGRGB_IGIG_GBGR_IGIG10_1X10, { BayerFormat::GRGB_IGIG_GBGR_IGIG, 10, BayerFormat::Packing::None } },
